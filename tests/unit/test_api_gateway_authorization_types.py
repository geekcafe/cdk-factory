...
class TestApiGatewayAuthorizationTypes(unittest.TestCase):
    ...
    def test_authorization_type_none(self):
        ...
        self.assertGreaterEqual(
            len(method_resources), 2, "Should have at least 2 methods"
        )
        ...
        self.assertEqual(
            len(none_methods), 2, "Both routes should have NONE authorization"
        )
    ...
    def test_secure_by_default_cognito_authorization(self):
                ...
                "api_gateway": {
                    ...
                    "routes": [
                        ...
                        },
                        {
                            ...
                            "src": "./src/cdk_factory/lambdas",
                            "handler": "health_handler.lambda_handler",
                            # No authorization_type - should default to COGNITO
                        },
                    ],
                },
            },
        ...
        method_resources = get_resources_by_type(cf_template, "AWS::ApiGateway::Method")
        self.assertGreaterEqual(
            len(method_resources), 3, "Should have at least 3 methods"
        )
        ...
        self.assertEqual(
            len(none_methods),
            1,
            "Should have 1 public route (authorization_type: NONE)",
        )
        self.assertEqual(
            len(cognito_methods), 2, "Should have 2 secure routes (explicit + default)"
        )
