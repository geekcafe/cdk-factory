...
from cdk_factory.constructs.lambdas.policies.policy_docs import PolicyDocuments, ResourceResolver
...
class TestPolicyDocumentsFlexibleResolution(unittest.TestCase):
    ...
    @patch('cdk_factory.constructs.lambdas.policies.policy_docs.ResourceResolver._get_ssm_mixin')
    ...
    def test_policy_documents_full_integration_with_permissions(self):
        ...
        for details in [read_details, write_details, delete_details]:
            ...
            self.assertTrue(any("integration-test-table" in resource for resource in resources))
