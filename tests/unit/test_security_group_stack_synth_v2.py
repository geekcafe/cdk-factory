...
# Create a helper class to patch the Protocol enum
...
def test_security_group_stack_synth(dummy_workload, monkeypatch):
    ...
    with patch.object(SecurityGroupStack, '_get_vpc') as mock_get_vpc:
        ...
        # Patch the Protocol constructor to use our helper
        monkeypatch.setattr(ec2, "Protocol", ProtocolHelper.get_protocol)
...
def test_security_group_with_peer_rules(dummy_workload, monkeypatch):
